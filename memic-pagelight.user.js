...
(function () {
  ...
  function updatePaginationBar(bar) {
    bar.querySelectorAll('button').forEach((b, idx) => {
      b.style.backgroundColor = idx === currentPage ? '#1976D2' : '#ffffff';
      b.style.color = idx === currentPage ? '#fff' : '#424242';
      b.style.fontWeight = idx === currentPage ? 'bold' : 'normal';
      b.style.borderColor = idx === currentPage ? '#1976D2' : '#ddd';
    });
  }
